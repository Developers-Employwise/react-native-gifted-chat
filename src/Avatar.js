...
export default class Avatar extends React.Component {
  renderAvatar() {
    ...
    return (
      <GiftedAvatar
        avatarStyle={StyleSheet.flatten([styles[this.props.position].image,  this.props.imageStyle[this.props.position], this.props.customAvatarStyle[this.props.position]])}
