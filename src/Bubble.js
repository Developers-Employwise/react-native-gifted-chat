...
export default class Bubble extends React.Component {
  ...
  renderCustomView() {
    if (this.props.renderCustomView) {
		if (this.props.currentMessage.isCustomViewVisible)	
  ...
  render() {
    return (
      <View style={[styles[this.props.position].container, this.props.containerStyle[this.props.position]]}>
        <View style={[styles[this.props.position].wrapper,this.props.bubbleStyle[this.props.position], this.props.wrapperStyle[this.props.position], this.handleBubbleToNext(), this.handleBubbleToPrevious()]}>
          <TouchableWithoutFeedback
